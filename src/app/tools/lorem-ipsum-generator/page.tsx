...
export const metadata: Metadata = {
  ...
  description: getMetaDescription('lorem-ipsum-generator', tool.description),
  alternates: {
    canonical: 'https://devtools-hub.vercel.app/tools/lorem-ipsum-generator',
  },
  openGraph: {
    title: `${tool.name} | devtools-hub`,
    description: getMetaDescription('lorem-ipsum-generator', tool.description),
    images: [{ url: '/tools/lorem-ipsum-generator/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function LoremIpsumGeneratorPage() {
  ...
  return (
    <main className="py-10">
      ...
      <AdSense slot="1010101036" format="horizontal" className="mb-8" />

      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="Lorem Ipsum Generator ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">Lorem Ipsum Generator</p>
        </div>
      ...
      <SeoArticle slug="lorem-ipsum-generator" />

      <AdSense slot="1010101037" format="rectangle" className="mb-12" />
