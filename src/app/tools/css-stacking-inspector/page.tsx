...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: tool.description,
    images: [{ url: '/tools/css-stacking-inspector/opengraph-image', width: 1200, height: 630 }],
  },
}

export default function CssStackingInspectorPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="CSS Stacking Inspector ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">CSS Stacking Inspector</p>
        </div>
        <div className="p-5 sm:p-6">
          <CssStackingInspector />
        </div>
      </section>
