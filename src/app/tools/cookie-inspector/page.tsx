...
const tool = tools.find((t) => t.slug === 'cookie-inspector')!
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('cookie-inspector', tool.description),
    images: [{ url: '/tools/cookie-inspector/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function CookieInspectorPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="Cookie Inspector ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">HTTP Cookie Inspector</p>
        </div>
      ...
      <SeoArticle slug="cookie-inspector" />
