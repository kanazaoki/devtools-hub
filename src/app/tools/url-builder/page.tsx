...
const tool = tools.find((t) => t.slug === 'url-builder')!

export const metadata: Metadata = {
  title: `${tool.name} — ${tool.tagline}`,
  description: getMetaDescription('url-builder', tool.description),
  alternates: {
    canonical: 'https://devtools-hub.vercel.app/tools/url-builder',
  },
  openGraph: {
    title: `${tool.name} | devtools-hub`,
    description: getMetaDescription('url-builder', tool.description),
    images: [{ url: '/tools/url-builder/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function UrlBuilderPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="URL Builder ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">URL Builder / Inspector</p>
        </div>
