...
import { ContainerQueryBuilder } from '@/components/tools/ContainerQueryBuilder'
import { ToolJsonLd } from '@/components/ToolJsonLd'
import { ToolBreadcrumb } from '@/components/ToolBreadcrumb'
import { SeoArticle } from '@/components/SeoArticle'
import { getMetaDescription } from '@/data/seo-content'

const tool = tools.find((t) => t.slug === 'container-query-builder')!
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('container-query-builder', tool.description),
    images: [{ url: '/tools/container-query-builder/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function ContainerQueryBuilderPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="CSS Container Query Builder ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">CSS Container Query Builder</p>
        </div>
      ...
      <SeoArticle slug="container-query-builder" />
