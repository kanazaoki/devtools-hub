...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('color-contrast-checker', tool.description),
    images: [{ url: '/tools/color-contrast-checker/opengraph-image', width: 1200, height: 630 }],
  },
}
    ...
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="Color Contrast Checker ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">Color Contrast Checker</p>
        </div>
