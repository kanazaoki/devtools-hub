...
export const metadata: Metadata = {
  ...
  description: getMetaDescription('css-grid-generator', tool.description),
  alternates: {
    canonical: 'https://devtools-hub.vercel.app/tools/css-grid-generator',
  },
  openGraph: {
    title: `${tool.name} | devtools-hub`,
    description: getMetaDescription('css-grid-generator', tool.description),
    images: [{ url: '/tools/css-grid-generator/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function CssGridGeneratorPage() {
  ...
  return (
    <main className="py-10">
      ...
      <AdSense slot="1010101070" format="horizontal" className="mb-8" />

      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="CSS Grid Generator ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">CSS Grid Generator</p>
        </div>
      ...
      <SeoArticle slug="css-grid-generator" />

      <AdSense slot="1010101071" format="rectangle" className="mb-12" />
