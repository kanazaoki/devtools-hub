...
import { SemverCalculator } from '@/components/tools/SemverCalculator'
import { ToolJsonLd } from '@/components/ToolJsonLd'
import { SeoArticle } from '@/components/SeoArticle'
import { getMetaDescription } from '@/data/seo-content'

const tool = tools.find((t) => t.slug === 'semver-calculator')!
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('semver-calculator', tool.description),
    images: [{ url: '/tools/semver-calculator/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function SemverCalculatorPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="Semver Calculator ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">Semver Calculator</p>
        </div>
      ...
      <SeoArticle slug="semver-calculator" />
