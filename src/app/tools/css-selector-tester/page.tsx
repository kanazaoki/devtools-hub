...
import { CssSelectorTester } from '@/components/tools/CssSelectorTester'
import { ToolJsonLd } from '@/components/ToolJsonLd'
import { ToolBreadcrumb } from '@/components/ToolBreadcrumb'
import { SeoArticle } from '@/components/SeoArticle'
import { getMetaDescription } from '@/data/seo-content'

const tool = tools.find((t) => t.slug === 'css-selector-tester')!
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('css-selector-tester', tool.description),
    images: [{ url: '/tools/css-selector-tester/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function CssSelectorTesterPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="CSS Selector Tester ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">CSS Selector Tester</p>
        </div>
      ...
      <SeoArticle slug="css-selector-tester" />
