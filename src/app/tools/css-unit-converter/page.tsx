...
const tool = tools.find((t) => t.slug === 'css-unit-converter')!
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('css-unit-converter', tool.description),
    images: [{ url: '/tools/css-unit-converter/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function CssUnitConverterPage() {
  ...
  return (
    <main className="py-10">
      ...
      <AdSense slot="1010101032" format="horizontal" className="mb-8" />

      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="CSS Unit Converter ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">CSS Unit Converter</p>
        </div>
      ...
      <SeoArticle slug="css-unit-converter" />

      <AdSense slot="1010101033" format="rectangle" className="mb-12" />
