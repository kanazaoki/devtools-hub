...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://devtools-hub.vercel.app/tools/markdown-table-generator',
  },
  openGraph: {
    title: `${tool.name} | devtools-hub`,
    description: getMetaDescription(tool.slug, tool.description),
    images: [{ url: '/tools/markdown-table-generator/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function MarkdownTableGeneratorPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="Markdown Table Generator ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">Markdown Table Generator</p>
        </div>
      ...
      <SeoArticle slug="markdown-table-generator" />
