...
export const metadata: Metadata = {
  ...
  description: getMetaDescription('color-palette-generator', tool.description),
  alternates: {
    canonical: 'https://devtools-hub.vercel.app/tools/color-palette-generator',
  },
  openGraph: {
    title: `${tool.name} | devtools-hub`,
    description: getMetaDescription('color-palette-generator', tool.description),
    images: [{ url: '/tools/color-palette-generator/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function ColorPaletteGeneratorPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="Color Palette Generator ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">Color Palette Generator</p>
        </div>
      ...
      <SeoArticle slug="color-palette-generator" />
