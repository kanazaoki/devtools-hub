...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('mockup-builder', tool.description),
    images: [{ url: '/tools/mockup-builder/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function MockupBuilderPage() {
  ...
  return (
    <main className="py-10">
      ...
      <AdSense slot="9999999991" format="horizontal" className="mb-8" />

      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="MockupBuilder ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">MockupBuilder</p>
        </div>
