...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://devtools-hub.vercel.app/tools/uuid-generator',
  },
  openGraph: {
...
export default function UuidGeneratorPage() {
  ...
  return (
    <main className="py-10">
      ...
      <AdSense slot="1010101020" format="horizontal" className="mb-8" />

      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="UUID ジェネレーター ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">UUID Generator</p>
        </div>
      ...
      <SeoArticle slug="uuid-generator" />

      <AdSense slot="1010101021" format="rectangle" className="mb-12" />
