...
export const metadata: Metadata = {
  ...
  description: getMetaDescription('curl-to-code', tool.description),
  alternates: {
    canonical: 'https://devtools-hub.vercel.app/tools/curl-to-code',
  },
  openGraph: {
    title: `${tool.name} | devtools-hub`,
    description: getMetaDescription('curl-to-code', tool.description),
    images: [{ url: '/tools/curl-to-code/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function CurlToCodePage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="cURL to Code ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">cURL to Code</p>
        </div>
