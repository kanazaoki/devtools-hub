...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://devtools-hub.vercel.app/tools/placeholder-image-generator',
  },
  openGraph: {
    title: `${tool.name} | devtools-hub`,
    description: tool.description,
    images: [{ url: '/tools/placeholder-image-generator/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function PlaceholderImageGeneratorPage() {
  ...
  return (
    <main className="py-10">
      ...
      <AdSense slot="1010101088" format="horizontal" className="mb-8" />

      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="Placeholder Image Generator ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">Placeholder Image Generator</p>
        </div>
      ...
      <AdSense slot="1010101089" format="rectangle" className="mb-12" />
