...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('html-to-markdown', tool.description),
    images: [{ url: '/tools/html-to-markdown/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function HtmlToMarkdownPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="HTML to Markdown Converter ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">HTML → Markdown Converter</p>
        </div>
      ...
      <SeoArticle slug="html-to-markdown" />
