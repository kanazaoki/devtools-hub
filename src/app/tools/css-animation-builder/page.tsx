...
export const metadata: Metadata = {
  ...
  description: getMetaDescription('css-animation-builder', tool.description),
  alternates: {
    canonical: 'https://devtools-hub.vercel.app/tools/css-animation-builder',
  },
  openGraph: {
    title: `${tool.name} | devtools-hub`,
    description: getMetaDescription('css-animation-builder', tool.description),
    images: [{ url: '/tools/css-animation-builder/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function CssAnimationBuilderPage() {
  ...
  return (
    <main className="py-10">
      ...
      <AdSense slot="1010101062" format="horizontal" className="mb-8" />

      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="CSS Animation Builder ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">CSS Animation Builder</p>
        </div>
