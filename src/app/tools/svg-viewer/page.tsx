...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('svg-viewer', tool.description),
    images: [{ url: '/tools/svg-viewer/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function SvgViewerPage() {
  ...
  return (
    <main className="py-10">
      ...
      <AdSense slot="1010101060" format="horizontal" className="mb-8" />

      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="SVG Viewer ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">SVG Viewer</p>
        </div>
      ...
      <SeoArticle slug="svg-viewer" />

      <AdSense slot="1010101061" format="rectangle" className="mb-12" />
