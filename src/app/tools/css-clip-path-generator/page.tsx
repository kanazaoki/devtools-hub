...
const tool = tools.find((t) => t.slug === 'css-clip-path-generator')!
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('css-clip-path-generator', tool.description),
    images: [{ url: '/tools/css-clip-path-generator/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function CssClipPathGeneratorPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="CSS Clip-Path Generator ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">CSS Clip-Path Generator</p>
        </div>
      ...
      <SeoArticle slug="css-clip-path-generator" />
