...
export const metadata: Metadata = {
  ...
  description: getMetaDescription('svg-optimizer', tool.description),
  alternates: {
    canonical: 'https://devtools-hub.dev/tools/svg-optimizer',
  },
  openGraph: {
    title: `${tool.name} | devtools-hub`,
    description: getMetaDescription('svg-optimizer', tool.description),
    images: [{ url: '/tools/svg-optimizer/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function SvgOptimizerPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="SVG Optimizer ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">SVG Optimizer</p>
        </div>
