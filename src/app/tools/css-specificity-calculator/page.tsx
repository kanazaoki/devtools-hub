...
const tool = tools.find((t) => t.slug === 'css-specificity-calculator')!
...
export default function CssSpecificityCalculatorPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="CSS Specificity Calculator ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">CSS Specificity Calculator</p>
        </div>
      ...
      <SeoArticle slug="css-specificity-calculator" />
