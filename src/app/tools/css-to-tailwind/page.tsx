...
import { CssToTailwind } from '@/components/tools/CssToTailwind'
import { ToolJsonLd } from '@/components/ToolJsonLd'
import { SeoArticle } from '@/components/SeoArticle'

const tool = tools.find((t) => t.slug === 'css-to-tailwind')!
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: tool.description,
    images: [{ url: '/tools/css-to-tailwind/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function CssToTailwindPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="CSS to Tailwind ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">CSS to Tailwind Converter</p>
        </div>
      ...
      <SeoArticle slug="css-to-tailwind" />
