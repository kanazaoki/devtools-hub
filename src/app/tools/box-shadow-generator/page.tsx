...
const tool = tools.find((t) => t.slug === 'box-shadow-generator')!
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('box-shadow-generator', tool.description),
    images: [{ url: '/tools/box-shadow-generator/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function BoxShadowGeneratorPage() {
  ...
  return (
    <main className="py-10">
      ...
      <AdSense slot="1010101038" format="horizontal" className="mb-8" />

      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="Box Shadow Generator ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">Box Shadow Generator</p>
        </div>
      ...
      <SeoArticle slug="box-shadow-generator" />

      <AdSense slot="1010101039" format="rectangle" className="mb-12" />
