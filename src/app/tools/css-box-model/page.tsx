...
import { CssBoxModel } from '@/components/tools/CssBoxModel'
import { ToolJsonLd } from '@/components/ToolJsonLd'
import { ToolBreadcrumb } from '@/components/ToolBreadcrumb'
import { SeoArticle } from '@/components/SeoArticle'

const tool = tools.find((t) => t.slug === 'css-box-model')!
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription(tool.slug, tool.description),
    images: [{ url: '/tools/css-box-model/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function CssBoxModelPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="CSS Box Model Visualizer ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">CSS Box Model Visualizer</p>
        </div>
