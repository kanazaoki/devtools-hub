...
export const metadata: Metadata = {
  ...
  description: getMetaDescription('yaml-json-converter', tool.description),
  alternates: {
    canonical: 'https://devtools-hub.vercel.app/tools/yaml-json-converter',
  },
  openGraph: {
    title: `${tool.name} | devtools-hub`,
    description: getMetaDescription('yaml-json-converter', tool.description),
    images: [{ url: '/tools/yaml-json-converter/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function YamlJsonConverterPage() {
  ...
  return (
    <main className="py-10">
      ...
      <AdSense slot="1010101058" format="horizontal" className="mb-8" />

      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="YAML JSON Converter ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">YAML / JSON / TOML Converter</p>
        </div>
