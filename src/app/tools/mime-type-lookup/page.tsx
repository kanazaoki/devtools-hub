...
const tool = tools.find((t) => t.slug === 'mime-type-lookup')!
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('mime-type-lookup', tool.description),
    images: [{ url: '/tools/mime-type-lookup/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function MimeTypeLookupPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="MIME Type Lookup ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">MIME Type Lookup</p>
        </div>
      ...
      <SeoArticle slug="mime-type-lookup" />
