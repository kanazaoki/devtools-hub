...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: tool.description,
    images: [{ url: '/tools/color-blindness-simulator/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function ColorBlindnessSimulatorPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="Color Blindness Simulator ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">Color Blindness Simulator</p>
        </div>
