...
const tool = tools.find((t) => t.slug === 'string-inspector')!
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription(tool.slug, tool.description),
    images: [{ url: '/tools/string-inspector/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function StringInspectorPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="String Inspector ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">String Inspector</p>
        </div>
      ...
      <SeoArticle slug="string-inspector" />
