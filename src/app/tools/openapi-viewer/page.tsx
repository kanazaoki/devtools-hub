...
const tool = tools.find((t) => t.slug === 'openapi-viewer')!
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('openapi-viewer', tool.description),
    images: [{ url: '/tools/openapi-viewer/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function OpenApiViewerPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="OpenAPI Viewer ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">OpenAPI Viewer</p>
        </div>
      ...
      <SeoArticle slug="openapi-viewer" />
