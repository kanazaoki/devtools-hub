...
export const metadata: Metadata = {
  ...
  description: getMetaDescription('aspect-ratio-calculator', tool.description),
  alternates: {
    canonical: 'https://devtools-hub.vercel.app/tools/aspect-ratio-calculator',
  },
  openGraph: {
    title: `${tool.name} | devtools-hub`,
    description: getMetaDescription('aspect-ratio-calculator', tool.description),
    images: [{ url: '/tools/aspect-ratio-calculator/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function AspectRatioCalculatorPage() {
  ...
  return (
    <main className="py-10">
      ...
      <AdSense slot="1010101034" format="horizontal" className="mb-8" />

      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="Aspect Ratio Calculator ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">Aspect Ratio Calculator</p>
        </div>
      ...
      <SeoArticle slug="aspect-ratio-calculator" />

      <AdSense slot="1010101035" format="rectangle" className="mb-12" />
