...
const tool = tools.find((t) => t.slug === 'http-request-builder')!

export const metadata: Metadata = {
  title: `${tool.name} — ${tool.tagline}`,
  description: getMetaDescription('http-request-builder', tool.description),
  alternates: {
    canonical: 'https://devtools-hub.vercel.app/tools/http-request-builder',
  },
  openGraph: {
    title: `${tool.name} | devtools-hub`,
    description: getMetaDescription('http-request-builder', tool.description),
    images: [{ url: '/tools/http-request-builder/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function HttpRequestBuilderPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="HTTP Request Builder ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">HTTP Request Builder</p>
        </div>
      ...
      <SeoArticle slug="http-request-builder" />
