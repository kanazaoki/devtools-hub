...
export const metadata: Metadata = {
  ...
  description: getMetaDescription('number-base-converter', tool.description),
  alternates: {
    canonical: 'https://devtools-hub.vercel.app/tools/number-base-converter',
  },
  openGraph: {
    title: `${tool.name} | devtools-hub`,
    description: getMetaDescription('number-base-converter', tool.description),
    images: [{ url: '/tools/number-base-converter/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function NumberBaseConverterPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="Number Base Converter ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">Number Base Converter</p>
        </div>
