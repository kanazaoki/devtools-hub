...
import { GradientDeck } from '@/components/tools/GradientDeck'
...
const tool = tools.find((t) => t.slug === 'gradient-deck')!

export const metadata: Metadata = {
  title: `${tool.name} — ${tool.tagline}`,
  description: getMetaDescription('gradient-deck', tool.description),
  alternates: {
    canonical: 'https://devtools-hub.dev/tools/gradient-deck',
  },
  openGraph: {
    title: `${tool.name} | devtools-hub`,
    description: getMetaDescription('gradient-deck', tool.description),
    images: [{ url: '/tools/gradient-deck/opengraph-image', width: 1200, height: 630 }],
  },
}

export default function GradientDeckPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section
        ...
        aria-label="Gradient Deck ツール"
      >
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">Gradient Deck</p>
        </div>
