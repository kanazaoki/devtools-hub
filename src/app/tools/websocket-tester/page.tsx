...
import { WebSocketTester } from '@/components/tools/WebSocketTester'
import { ToolJsonLd } from '@/components/ToolJsonLd'
import { ToolBreadcrumb } from '@/components/ToolBreadcrumb'
import { SeoArticle } from '@/components/SeoArticle'
import { getMetaDescription } from '@/data/seo-content'

const tool = tools.find((t) => t.slug === 'websocket-tester')!
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('websocket-tester', tool.description),
    images: [{ url: '/tools/websocket-tester/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function WebSocketTesterPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="WebSocket Tester ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">WebSocket Tester</p>
        </div>
      ...
      <SeoArticle slug="websocket-tester" />
