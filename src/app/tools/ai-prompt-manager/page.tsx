...
import { AiPromptManager } from '@/components/tools/AiPromptManager'
...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://devtools-hub.vercel.app/tools/ai-prompt-manager',
  },
  openGraph: {
    title: `${tool.name} | devtools-hub`,
    description: getMetaDescription('ai-prompt-manager', tool.description),
    images: [{ url: '/tools/ai-prompt-manager/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function AiPromptManagerPage() {
  ...
  return (
    <main className="py-10">
      ...
      <AdSense slot="7777777771" format="horizontal" className="mb-8" />

      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="AI Prompt Manager ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">AI Prompt Manager</p>
        </div>
      ...
      <SeoArticle slug="ai-prompt-manager" />

      <AdSense slot="7777777772" format="rectangle" className="mb-12" />
