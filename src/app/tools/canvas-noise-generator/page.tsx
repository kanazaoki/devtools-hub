...
import { CanvasNoiseGenerator } from '@/components/tools/CanvasNoiseGenerator'
import { ToolJsonLd } from '@/components/ToolJsonLd'
import { SeoArticle } from '@/components/SeoArticle'
import { getMetaDescription } from '@/data/seo-content'

const tool = tools.find((t) => t.slug === 'canvas-noise-generator')!
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('canvas-noise-generator', tool.description),
    images: [{ url: '/tools/canvas-noise-generator/opengraph-image', width: 1200, height: 630 }],
  },
}

export default function CanvasNoiseGeneratorPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="Canvas Noise Generator ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">Canvas Noise Generator</p>
        </div>
      ...
      <SeoArticle slug="canvas-noise-generator" />
