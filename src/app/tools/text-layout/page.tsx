...
import { TextLayoutChecker } from '@/components/tools/TextLayoutChecker'
...
const tool = tools.find((t) => t.slug === 'text-layout')!
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('text-layout', tool.description),
    images: [{ url: '/tools/text-layout/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function TextLayoutPage() {
  ...
  return (
    <main className="py-10">
      ...
      <AdSense slot="5555555555" format="horizontal" className="mb-8" />

      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="Text Layout Checker ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">Text Layout Checker</p>
        </div>
      ...
      <SeoArticle slug="text-layout" />

      <AdSense slot="5555555556" format="rectangle" className="mb-12" />
