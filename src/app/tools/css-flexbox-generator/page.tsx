...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://devtools-hub.vercel.app/tools/css-flexbox-generator',
  },
  openGraph: {
    title: `${tool.name} | devtools-hub`,
    description: tool.description,
    images: [{ url: '/tools/css-flexbox-generator/opengraph-image', width: 1200, height: 630 }],
  },
}
    ...
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="CSS Flexbox Generator ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">CSS Flexbox Generator</p>
        </div>
