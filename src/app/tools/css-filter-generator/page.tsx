...
export const metadata: Metadata = {
  ...
  description: getMetaDescription('css-filter-generator', tool.description),
  alternates: {
    canonical: 'https://devtools-hub.vercel.app/tools/css-filter-generator',
  },
  openGraph: {
    title: `${tool.name} | devtools-hub`,
    description: getMetaDescription('css-filter-generator', tool.description),
    images: [{ url: '/tools/css-filter-generator/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function CssFilterGeneratorPage() {
  ...
  return (
    <main className="py-10">
      ...
      <AdSense slot="1010101042" format="horizontal" className="mb-8" />

      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="CSS Filter Generator ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">CSS Filter Generator</p>
        </div>
