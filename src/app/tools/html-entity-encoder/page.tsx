...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('html-entity-encoder', tool.description),
    images: [{ url: '/tools/html-entity-encoder/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function HtmlEntityEncoderPage() {
  ...
  return (
    <main className="py-10">
      ...
      <AdSense slot="1010101052" format="horizontal" className="mb-8" />

      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="HTML Entity Encoder ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">HTML Entity Encoder</p>
        </div>
      ...
      <SeoArticle slug="html-entity-encoder" />

      <AdSense slot="1010101053" format="rectangle" className="mb-12" />
