...
const tool = tools.find((t) => t.slug === 'ascii-art-generator')!
...
export default function AsciiArtGeneratorPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="ASCII Art Generator ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">ASCII Art Generator</p>
        </div>
      ...
      <SeoArticle slug="ascii-art-generator" />
