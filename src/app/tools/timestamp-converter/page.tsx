...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('timestamp-converter', tool.description),
    images: [{ url: '/tools/timestamp-converter/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function TimestampConverterPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="Timestamp Converter ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">Timestamp Converter</p>
        </div>
      ...
      <SeoArticle slug="timestamp-converter" />
