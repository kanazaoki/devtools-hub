...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://devtools-hub.dev/tools/base64-studio',
  },
  openGraph: {
    title: `${tool.name} | devtools-hub`,
    description: getMetaDescription('base64-studio', tool.description),
    images: [{ url: '/tools/base64-studio/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function Base64StudioPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="base64-studio ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">base64-studio</p>
        </div>
