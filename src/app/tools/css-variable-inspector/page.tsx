...
import { CssVariableInspector } from '@/components/tools/CssVariableInspector'
import { ToolJsonLd } from '@/components/ToolJsonLd'
import { SeoArticle } from '@/components/SeoArticle'
import { getMetaDescription } from '@/data/seo-content'

const tool = tools.find((t) => t.slug === 'css-variable-inspector')!
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('css-variable-inspector', tool.description),
    images: [{ url: '/tools/css-variable-inspector/opengraph-image', width: 1200, height: 630 }],
  },
}

export default function CssVariableInspectorPage() {
  ...
  return (
    <main className="py-10">
      ...
      <AdSense slot="1010101040" format="horizontal" className="mb-8" />

      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="CSS Variable Inspector ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">CSS Variable Inspector</p>
        </div>
      ...
      <SeoArticle slug="css-variable-inspector" />

      <AdSense slot="1010101041" format="rectangle" className="mb-12" />
