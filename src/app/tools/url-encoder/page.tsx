...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('url-encoder', tool.description),
    images: [{ url: '/tools/url-encoder/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function UrlEncoderPage() {
  ...
  return (
    <main className="py-10">
      ...
      <AdSense slot="1010101014" format="horizontal" className="mb-8" />

      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="URL Encoder/Decoder ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">URL Encoder / Decoder</p>
        </div>
      ...
      <SeoArticle slug="url-encoder" />

      <AdSense slot="1010101015" format="rectangle" className="mb-12" />
