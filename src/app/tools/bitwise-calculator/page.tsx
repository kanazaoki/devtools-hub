...
const tool = tools.find((t) => t.slug === 'bitwise-calculator')!
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('bitwise-calculator', tool.description),
    images: [{ url: '/tools/bitwise-calculator/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function BitwiseCalculatorPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="Bitwise Calculator ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">Bitwise Calculator</p>
        </div>
      ...
      <SeoArticle slug="bitwise-calculator" />
