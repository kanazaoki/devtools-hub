...
import { FontInspector } from '@/components/tools/FontInspector'
import { ToolJsonLd } from '@/components/ToolJsonLd'
import { ToolBreadcrumb } from '@/components/ToolBreadcrumb'
import { SeoArticle } from '@/components/SeoArticle'
import { getMetaDescription } from '@/data/seo-content'

const tool = tools.find((t) => t.slug === 'font-inspector')!
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('font-inspector', tool.description),
    images: [{ url: '/tools/font-inspector/opengraph-image', width: 1200, height: 630 }],
  },
}

export default function FontInspectorPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="Font Inspector ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">Font Inspector</p>
        </div>
      ...
      <SeoArticle slug="font-inspector" />
