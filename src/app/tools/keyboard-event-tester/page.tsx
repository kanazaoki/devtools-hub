...
import { KeyboardEventTester } from '@/components/tools/KeyboardEventTester'
...
const tool = tools.find((t) => t.slug === 'keyboard-event-tester')!
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('keyboard-event-tester', tool.description),
    images: [{ url: '/tools/keyboard-event-tester/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function KeyboardEventTesterPage() {
  ...
  return (
    <main className="py-10">
      ...
      <AdSense slot="1010101080" format="horizontal" className="mb-8" />

      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="Keyboard Event Tester ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">Keyboard Event Tester</p>
        </div>
      ...
      <SeoArticle slug="keyboard-event-tester" />

      <AdSense slot="1010101081" format="rectangle" className="mb-12" />
