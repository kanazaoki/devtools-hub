...
const tool = tools.find((t) => t.slug === 'color-format-converter')!

export const metadata: Metadata = {
  title: `${tool.name} — ${tool.tagline}`,
  description: getMetaDescription('color-format-converter', tool.description),
  alternates: {
    canonical: 'https://devtools-hub.vercel.app/tools/color-format-converter',
  },
  openGraph: {
    title: `${tool.name} | devtools-hub`,
    description: getMetaDescription('color-format-converter', tool.description),
    images: [{ url: '/tools/color-format-converter/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function ColorFormatConverterPage() {
  ...
  return (
    <main className="py-10">
      ...
      <AdSense slot="1010101046" format="horizontal" className="mb-8" />

      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="Color Format Converter ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">Color Format Converter</p>
        </div>
      ...
      <SeoArticle slug="color-format-converter" />

      <AdSense slot="1010101047" format="rectangle" className="mb-12" />
