...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://devtools-hub.dev/tools/json-to-typescript',
  },
  openGraph: {
    title: `${tool.name} | devtools-hub`,
    description: getMetaDescription('json-to-typescript', tool.description),
    images: [{ url: '/tools/json-to-typescript/opengraph-image', width: 1200, height: 630 }],
  },
}
    ...
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="JSON to TypeScript ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">JSON to TypeScript</p>
        </div>
