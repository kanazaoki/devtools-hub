...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: tool.description,
    images: [{ url: '/tools/timezone-converter/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function TimezoneConverterPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="Time Zone Converter ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">Time Zone Converter</p>
        </div>
      ...
      <SeoArticle slug="timezone-converter" />
