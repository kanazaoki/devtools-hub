...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('character-counter', tool.description),
    images: [{ url: '/tools/character-counter/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function CharacterCounterPage() {
  ...
  return (
    <main className="py-10">
      ...
      <AdSense slot="1010101048" format="horizontal" className="mb-8" />

      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="文字数カウンター ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">Character Counter</p>
        </div>
      ...
      <SeoArticle slug="character-counter" />

      <AdSense slot="1010101049" format="rectangle" className="mb-12" />
