...
const tool = tools.find((t) => t.slug === 'fake-data-generator')!
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('fake-data-generator', tool.description),
    images: [{ url: '/tools/fake-data-generator/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function FakeDataGeneratorPage() {
  ...
  return (
    <main className="py-10">
      ...
      <SeoArticle slug="fake-data-generator" />
