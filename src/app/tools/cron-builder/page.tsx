...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('cron-builder', tool.description),
    images: [{ url: '/tools/cron-builder/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function CronBuilderPage() {
  ...
  return (
    <main className="py-10">
      ...
      <AdSense slot="1010101024" format="horizontal" className="mb-8" />

      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="CRON 式ビルダー ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">Cron Builder</p>
        </div>
      ...
      <SeoArticle slug="cron-builder" />

      <AdSense slot="1010101025" format="rectangle" className="mb-12" />
