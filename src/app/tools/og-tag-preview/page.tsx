...
import { OgTagPreview } from '@/components/tools/OgTagPreview'
...
const tool = tools.find((t) => t.slug === 'og-tag-preview')!

export const metadata: Metadata = {
  title: `${tool.name} — ${tool.tagline}`,
  description: getMetaDescription('og-tag-preview', tool.description),
  alternates: {
    canonical: 'https://devtools-hub.vercel.app/tools/og-tag-preview',
  },
  openGraph: {
...
export default function OgTagPreviewPage() {
  ...
  return (
    <main className="py-10">
      ...
      <AdSense slot="1010101082" format="horizontal" className="mb-8" />

      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="OG Tag Preview ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">OG Tag Preview</p>
        </div>
      ...
      <SeoArticle slug="og-tag-preview" />

      <AdSense slot="1010101083" format="rectangle" className="mb-12" />
