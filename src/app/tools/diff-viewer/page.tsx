...
const tool = tools.find((t) => t.slug === 'diff-viewer')!

export const metadata: Metadata = {
  title: `${tool.name} — ${tool.tagline}`,
  description: getMetaDescription('diff-viewer', tool.description),
  alternates: {
    canonical: 'https://devtools-hub.vercel.app/tools/diff-viewer',
  },
  openGraph: {
    title: `${tool.name} | devtools-hub`,
    description: getMetaDescription('diff-viewer', tool.description),
    images: [{ url: '/tools/diff-viewer/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function DiffViewerPage() {
  ...
  return (
    <main className="py-10">
      ...
      <AdSense slot="1010101012" format="horizontal" className="mb-8" />

      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="Diff Viewer ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">Diff Viewer</p>
        </div>
      ...
      <SeoArticle slug="diff-viewer" />

      <AdSense slot="1010101013" format="rectangle" className="mb-12" />
