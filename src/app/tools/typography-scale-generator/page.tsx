...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://devtools-hub.vercel.app/tools/typography-scale-generator',
  },
  openGraph: {
    title: `${tool.name} | devtools-hub`,
    description: tool.description,
    images: [{ url: '/tools/typography-scale-generator/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function TypographyScaleGeneratorPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="Typography Scale Generator ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">Typography Scale Generator</p>
        </div>
