...
import { PixelArtPalette } from '@/components/tools/PixelArtPalette'
...
const tool = tools.find((t) => t.slug === 'pixel-art-palette')!
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('pixel-art-palette', tool.description),
    images: [{ url: '/tools/pixel-art-palette/opengraph-image', width: 1200, height: 630 }],
  },
}

export default function PixelArtPalettePage() {
  ...
  return (
    <main className="py-10">
      ...
      <AdSense slot="1010101044" format="horizontal" className="mb-8" />

      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="Pixel Art Palette ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">Pixel Art Palette</p>
        </div>
      ...
      <SeoArticle slug="pixel-art-palette" />

      <AdSense slot="1010101045" format="rectangle" className="mb-12" />
