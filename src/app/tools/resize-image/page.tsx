...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('resize-image', tool.description),
    images: [{ url: '/tools/resize-image/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function ResizeImagePage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="アイコン一括リサイズ ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">アイコン一括リサイズ</p>
        </div>
