...
import { HttpCacheBuilder } from '@/components/tools/HttpCacheBuilder'
import { ToolJsonLd } from '@/components/ToolJsonLd'
import { ToolBreadcrumb } from '@/components/ToolBreadcrumb'
import { SeoArticle } from '@/components/SeoArticle'
import { getMetaDescription } from '@/data/seo-content'

const tool = tools.find((t) => t.slug === 'http-cache-builder')!
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('http-cache-builder', tool.description),
    images: [{ url: '/tools/http-cache-builder/opengraph-image', width: 1200, height: 630 }],
  },
}

export default function HttpCacheBuilderPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="HTTP Cache Header Builder ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">HTTP Cache Header Builder</p>
        </div>
      ...
      <SeoArticle slug="http-cache-builder" />
