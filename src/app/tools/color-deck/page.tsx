...
import { ColorDeck } from '@/components/tools/ColorDeck'
...
const tool = tools.find((t) => t.slug === 'color-deck')!

export const metadata: Metadata = {
  title: `${tool.name} — ${tool.tagline}`,
  description: getMetaDescription('color-deck', tool.description),
  alternates: {
    canonical: 'https://devtools-hub.vercel.app/tools/color-deck',
  },
  openGraph: {
    title: `${tool.name} | devtools-hub`,
    description: getMetaDescription('color-deck', tool.description),
    images: [{ url: '/tools/color-deck/opengraph-image', width: 1200, height: 630 }],
  },
}

export default function ColorDeckPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section
        ...
        aria-label="color-deck ツール"
      >
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">Color Deck</p>
        </div>
