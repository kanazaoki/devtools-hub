...
const tool = tools.find((t) => t.slug === 'mermaid-preview')!
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('mermaid-preview', tool.description),
    images: [{ url: '/tools/mermaid-preview/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function MermaidPreviewPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="Mermaid Preview ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">Mermaid Preview</p>
        </div>
      ...
      <SeoArticle slug="mermaid-preview" />
