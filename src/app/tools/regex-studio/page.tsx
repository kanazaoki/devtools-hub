...
const tool = tools.find((t) => t.slug === 'regex-studio')!
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('regex-studio', tool.description),
    images: [{ url: '/tools/regex-studio/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function RegexStudioPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="Regex Studio ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">Regex Studio</p>
        </div>
