...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical: 'https://devtools-hub.vercel.app/tools/favicon-generator',
  },
  openGraph: {
    title: `${tool.name} | devtools-hub`,
    description: getMetaDescription(tool.slug, tool.description),
    images: [{ url: '/tools/favicon-generator/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function FaviconGeneratorPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="Favicon Generator ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">Favicon Generator</p>
        </div>
      ...
      <SeoArticle slug="favicon-generator" />
