...
import { SheetStudio } from '@/components/tools/SheetStudio'
...
const tool = tools.find((t) => t.slug === 'sheet-studio')!
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('sheet-studio', tool.description),
    images: [{ url: '/tools/sheet-studio/opengraph-image', width: 1200, height: 630 }],
  },
}

export default function SheetStudioPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="Sheet Studio ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">Sheet Studio</p>
        </div>
