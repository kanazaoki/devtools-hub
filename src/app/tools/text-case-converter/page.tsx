...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('text-case-converter', tool.description),
    images: [{ url: '/tools/text-case-converter/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function TextCaseConverterPage() {
  ...
  return (
    <main className="py-10">
      ...
      <AdSense slot="1010101028" format="horizontal" className="mb-8" />

      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="Text Case Converter ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">Text Case Converter</p>
        </div>
      ...
      <SeoArticle slug="text-case-converter" />

      <AdSense slot="1010101029" format="rectangle" className="mb-12" />
