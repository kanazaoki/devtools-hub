...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('markdown-preview', tool.description),
    images: [{ url: '/tools/markdown-preview/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function MarkdownPreviewPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="Markdown Preview ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">Markdown Preview</p>
        </div>
