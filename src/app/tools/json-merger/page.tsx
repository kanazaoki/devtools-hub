...
const tool = tools.find((t) => t.slug === 'json-merger')!

export const metadata: Metadata = {
  title: `${tool.name} — ${tool.tagline}`,
  description: getMetaDescription('json-merger', tool.description),
  alternates: {
    canonical: 'https://devtools-hub.vercel.app/tools/json-merger',
  },
  openGraph: {
    title: `${tool.name} | devtools-hub`,
    description: getMetaDescription('json-merger', tool.description),
    images: [{ url: '/tools/json-merger/opengraph-image', width: 1200, height: 630 }],
  },
}

export default function JsonMergerPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="JSON Merge Tool ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">JSON Merge Tool</p>
        </div>
