...
export const metadata: Metadata = {
  ...
  description: getMetaDescription('totp-generator', tool.description),
  alternates: {
    canonical: 'https://devtools-hub.vercel.app/tools/totp-generator',
  },
  openGraph: {
    title: `${tool.name} | devtools-hub`,
    description: getMetaDescription('totp-generator', tool.description),
    images: [{ url: '/tools/totp-generator/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function TotpGeneratorPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="TOTP Generator ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">TOTP / 2FA Code Generator</p>
        </div>
      ...
      <SeoArticle slug="totp-generator" />
