...
export const metadata: Metadata = {
  ...
  description: getMetaDescription('jwt-decoder', tool.description),
  alternates: {
    canonical: 'https://devtools-hub.vercel.app/tools/jwt-decoder',
  },
  openGraph: {
    title: `${tool.name} | devtools-hub`,
    description: getMetaDescription('jwt-decoder', tool.description),
    images: [{ url: '/tools/jwt-decoder/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function JwtDecoderPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="JWT Decoder ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">JWT Decoder</p>
        </div>
