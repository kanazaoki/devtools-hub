...
const tool = tools.find((t) => t.slug === 'image-color-extractor')!
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('image-color-extractor', tool.description),
    images: [{ url: '/tools/image-color-extractor/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function ImageColorExtractorPage() {
  ...
  return (
    <main className="py-10">
      ...
      <AdSense slot="1010101084" format="horizontal" className="mb-8" />

      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="Image Color Extractor ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">Image Color Extractor</p>
        </div>
      ...
      <SeoArticle slug="image-color-extractor" />

      <AdSense slot="1010101085" format="rectangle" className="mb-12" />
