...
import { JsonSizeAnalyzer } from '@/components/tools/JsonSizeAnalyzer'
import { ToolJsonLd } from '@/components/ToolJsonLd'
import { ToolBreadcrumb } from '@/components/ToolBreadcrumb'
import { SeoArticle } from '@/components/SeoArticle'
import { getMetaDescription } from '@/data/seo-content'

const tool = tools.find((t) => t.slug === 'json-size-analyzer')!
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('json-size-analyzer', tool.description),
    images: [{ url: '/tools/json-size-analyzer/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function JsonSizeAnalyzerPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="JSON Size Analyzer ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">JSON Size Analyzer</p>
        </div>
      ...
      <SeoArticle slug="json-size-analyzer" />
