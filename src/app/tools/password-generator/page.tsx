...
export const metadata: Metadata = {
  ...
  description: getMetaDescription('password-generator', tool.description),
  alternates: {
    canonical: 'https://devtools-hub.vercel.app/tools/password-generator',
  },
  openGraph: {
    title: `${tool.name} | devtools-hub`,
    description: getMetaDescription('password-generator', tool.description),
    images: [{ url: '/tools/password-generator/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function PasswordGeneratorPage() {
  ...
  return (
    <main className="py-10">
      ...
      <AdSense slot="1010101022" format="horizontal" className="mb-8" />

      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="パスワードジェネレーター ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">Password Generator</p>
        </div>
      ...
      <SeoArticle slug="password-generator" />

      <AdSense slot="1010101023" format="rectangle" className="mb-12" />
