...
const tool = tools.find((t) => t.slug === 'gitignore-generator')!

export const metadata: Metadata = {
  title: `${tool.name} — ${tool.tagline}`,
  description: tool.description,
  alternates: {
    canonical: 'https://devtools-hub.vercel.app/tools/gitignore-generator',
  },
  openGraph: {
    title: `${tool.name} | devtools-hub`,
    description: tool.description,
    images: [{ url: '/tools/gitignore-generator/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function GitignoreGeneratorPage() {
  ...
  return (
    <main className="py-10">
      ...
      <AdSense slot="8701234501" format="horizontal" className="mb-8" />

      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label=".gitignore Generator ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">.gitignore Generator</p>
        </div>
      ...
      <SeoArticle slug="gitignore-generator" />

      <AdSense slot="8701234502" format="rectangle" className="mb-12" />
