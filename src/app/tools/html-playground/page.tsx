...
import { HtmlPlayground } from '@/components/tools/HtmlPlayground'
import { ToolJsonLd } from '@/components/ToolJsonLd'
import { SeoArticle } from '@/components/SeoArticle'

const tool = tools.find((t) => t.slug === 'html-playground')!

export const metadata: Metadata = {
  title: `${tool.name} — ${tool.tagline}`,
  description: tool.description,
  alternates: {
    canonical: 'https://devtools-hub.vercel.app/tools/html-playground',
  },
  openGraph: {
    title: `${tool.name} | devtools-hub`,
    description: tool.description,
    images: [{ url: '/tools/html-playground/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function HtmlPlaygroundPage() {
  ...
  return (
    <main className="py-10">
      ...
      <AdSense slot="1010101098" format="horizontal" className="mb-8" />

      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="HTML Playground ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">HTML / CSS / JS Playground</p>
        </div>
      ...
      <SeoArticle slug="html-playground" />

      <AdSense slot="1010101099" format="rectangle" className="mb-12" />
