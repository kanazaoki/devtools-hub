...
export const metadata: Metadata = {
  ...
  description: getMetaDescription('json-to-sql', tool.description),
  alternates: {
    canonical: 'https://devtools-hub.vercel.app/tools/json-to-sql',
  },
  openGraph: {
    title: `${tool.name} | devtools-hub`,
    description: getMetaDescription('json-to-sql', tool.description),
    images: [{ url: '/tools/json-to-sql/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function JsonToSqlPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="JSON to SQL Generator ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">JSON → SQL Generator</p>
        </div>
