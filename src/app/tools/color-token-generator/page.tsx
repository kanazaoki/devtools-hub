...
import { ColorTokenGenerator } from '@/components/tools/ColorTokenGenerator'
...
const tool = tools.find((t) => t.slug === 'color-token-generator')!

export const metadata: Metadata = {
  title: `${tool.name} — ${tool.tagline}`,
  description: getMetaDescription('color-token-generator', tool.description),
  alternates: {
    canonical: 'https://devtools-hub.vercel.app/tools/color-token-generator',
  },
  openGraph: {
    title: `${tool.name} | devtools-hub`,
    description: getMetaDescription('color-token-generator', tool.description),
    images: [{ url: '/tools/color-token-generator/opengraph-image', width: 1200, height: 630 }],
  },
}

export default function ColorTokenGeneratorPage() {
  ...
  return (
    <main className="py-10">
      ...
      <AdSense slot="1010101016" format="horizontal" className="mb-8" />

      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="Color Token Generator ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">Color Token Generator</p>
        </div>
      ...
      <SeoArticle slug="color-token-generator" />
