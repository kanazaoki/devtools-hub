...
const tool = tools.find((t) => t.slug === 'json-schema-validator')!
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('json-schema-validator', tool.description),
    images: [{ url: '/tools/json-schema-validator/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function JsonSchemaValidatorPage() {
  ...
  return (
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="JSON Schema Validator ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">JSON Schema Validator</p>
        </div>
      ...
      <SeoArticle slug="json-schema-validator" />
