...
import { HttpHeadersReference } from '@/components/tools/HttpHeadersReference'
import { ToolJsonLd } from '@/components/ToolJsonLd'

const tool = tools.find((t) => t.slug === 'http-headers-reference')!
...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: tool.description,
    images: [{ url: '/tools/http-headers-reference/opengraph-image', width: 1200, height: 630 }],
  },
}

export default function HttpHeadersReferencePage() {
  ...
  return (
    <main className="py-10">
      ...
      <AdSense slot="1010101094" format="horizontal" className="mb-8" />

      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="HTTP Headers Reference ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">HTTP Headers Reference</p>
        </div>
      ...
      <AdSense slot="1010101095" format="rectangle" className="mb-12" />
