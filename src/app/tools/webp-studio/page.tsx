...
export const metadata: Metadata = {
  ...
  description: getMetaDescription('webp-studio', tool.description),
  alternates: {
    canonical: 'https://devtools-hub.vercel.app/tools/webp-studio',
  },
  openGraph: {
    title: `${tool.name} | devtools-hub`,
    description: getMetaDescription('webp-studio', tool.description),
    images: [{ url: '/tools/webp-studio/opengraph-image', width: 1200, height: 630 }],
  },
}

export default function WebpStudioPage() {
    ...
    <main className="py-10">
      ...
      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="WebP Studio ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">WebP Studio</p>
        </div>
