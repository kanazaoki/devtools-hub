...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description: getMetaDescription('qr-code', tool.description),
    images: [{ url: '/tools/qr-code/opengraph-image', width: 1200, height: 630 }],
  },
}
...
export default function QrCodePage() {
  ...
  return (
    <main className="py-10">
      ...
      <AdSense slot="1010101018" format="horizontal" className="mb-8" />

      <section className="mb-8 overflow-hidden rounded-lg border border-border bg-surface" aria-label="QR コード ツール">
        <div className="border-b border-border px-5 py-3">
          <p className="font-mono text-xs uppercase tracking-widest text-muted">QR Code Generator</p>
        </div>
      ...
      <SeoArticle slug="qr-code" />

      <AdSense slot="1010101019" format="rectangle" className="mb-12" />
